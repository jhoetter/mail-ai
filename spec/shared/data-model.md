...
A JWZ-threaded group of messages. Threads are overlay-only — IMAP has no concept of threads. The same RFC 822 message in two folders ends up in one Thread because dedup runs _before_ threading.
